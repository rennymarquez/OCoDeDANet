...
@dataclass
class DBNMFARDConfig():
    """Docstring for DBNMFARDConfig. """
    eps: float = 2.223e-16
    matrix_seed: int = 1
...
class DBNMFARD(Model):
    """Docstring for DBNMFARD. """
    config = DBNMFARDConfig()
    ...
    def update_data(self) -> None:
        ...
        """
        self._data.set_past_data(self._time, self._vars["W"], self._vars["H"])
